const CACHE='ejaps-v7';
const ASSETS=['./','./index.html','./styles.css','./simple.css','./brand.css','./app-v5.js','./simple-ui.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.webp'];
